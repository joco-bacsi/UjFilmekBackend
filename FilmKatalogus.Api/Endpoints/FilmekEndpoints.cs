...
public static class FilmekEndpoints
{
    ...
    public static void MapFilmekEndpoints(this WebApplication app)
    {
        ...
        //GET filmcast
        var filmcast = app.MapGroup("filmcast")
                               .WithParameterValidation();

        // GET /games
        filmcast.MapGet("/", async (FilmKatalogusContext dbContext) =>
        await dbContext.FilmCast.Select(f => f.ToSummaryDto()).AsNoTracking().ToListAsync());

        //GET filmcast by id
        filmcast.MapGet("/{id}", async (int id, FilmKatalogusContext dbContext) =>
                {
        ...
        //POST filmcast
        filmcast.MapPost("/", async (CreateFilmCastDto ujFilmCast, FilmKatalogusContext dbContext) =>
                {
        ...
        //PUT filmcast
        filmcast.MapPut("/", async (int id, UpdateFilmCastDto frissitettFilmCast, FilmKatalogusContext dbContext) =>
        {
